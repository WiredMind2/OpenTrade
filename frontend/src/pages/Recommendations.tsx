...
const categories: Category[] = [
  {
    ...
    description: 'Basic rules to avoid losing more than you can afford.',
    icon: ShieldAlert,
    rules: [
  ...
  },
  {
    id: 'backtesting',
    title: 'Backtesting',
    description: 'Test your strategy before risking real money.',
    icon: FlaskConical,
    rules: [
      ...
      { text: 'Aim for a Sharpe ratio above 1.5 before trading live.', level: 'note' },
    ],
  },
  {
    id: 'entries',
    title: 'Entries & Signals',
    description: 'Only enter a trade when the conditions are right.',
    icon: TrendingUp,
    rules: [
  ...
  },
  {
    id: 'discipline',
    title: 'Discipline',
    description: 'Stick to your plan, no matter what.',
    icon: Brain,
    rules: [
